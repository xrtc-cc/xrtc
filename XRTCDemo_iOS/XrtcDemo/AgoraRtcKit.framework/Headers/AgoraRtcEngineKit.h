...
#import "AgoraSnapshotCallback.h"
 ...
 *
 */
- (NSInteger)takeSnapshot:(NSString* _Nonnull)channel uid:(NSInteger)uid filePath:(NSString* _Nonnull)filePath completion:(id<AgoraSnapshotCallbackDelegate>)snapshotDelegate;
/**
 ContentInspect.

 @param enabled  Enable content inspect.
 @return 0: Success.
 * < 0: Failure.
 */
...
/**
 ...
 @param configuration  AgoraContentInspectConfig.
 @return 0: Success.
 * < 0: Failure.
 */
- (int)enableContentInspect:(BOOL)enabled config:(AgoraContentInspectConfig*)config;
